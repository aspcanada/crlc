export const hero = {
  title: "The Cottonwood Rose Learning Community",
  tagline:
  ...
  noteForFamilies:
    "For curious families: Please note, this program is in its first season! We are a small and passionate team with a big vision and learning as we go.",
  availability:
    "We welcome you to reach out to cottonwoodrosesociety@gmail.com to organize a visit to the land and try a day of programming to see if it's a fit for your family.",
  intro:
  ...
  resourcesNote:
    "For registered families there is also a resource page from which you can access all the most important program material.",
};
...
For 3 days each week of the school year, (Tue/Wed/Thur) 3 mixed age cohorts engage with the learning objectives of the BC-curriculum but finessed through the lens of nature. Mondays and Fridays are home learning days where kids will continue their project based work at home.`,
  ...
  fees: "Program fees operate on a sliding scale fee $197-$279 / month for 1 student and $355 - $497/month for 2 students. Registered families also receive $600 of provincial funding for each student a year that is paid to our nature education partners.",
};
...
export const partners = [
  {
    ...
    description: `Heartwood Learning Communities, offered in partnership with NIDES, a province wide alternative education programmer, provides children with a blended education rooted in both academic excellence and experiential learning.
...
By fostering curiosity, creativity, and care for the earth, Hand-in-Hand helps young learners build strong foundations for both academic and social growth—nurturing resilience, wonder, and a lifelong love of nature.`,
      },
      {
        ...
        description: `Danu Folk School invites children and youth into learning that's rich, hands-on, and heart-centered.
